...
local Window = OrionLib:MakeWindow({Name = "Swordburst 3", HidePremium = false, SaveConfig = true, ConfigFolder = "SB3", ShowIcon = true})
...
local raritys = {"Common", "Uncommon and below", "Rare and below", "Epic and below", "Legendary and below"}
local realrarity = {["Common"] = 1, ["Uncommon and below"] = 2, ["Rare and below"] = 3, ["Epic and below"] = 4, ["Legendary and below"] = 5,}
...
mainTab:AddParagraph("Auto Farm Mobs","If no one in the area, the mobs won't spawn")
mainTab:AddToggle({
	Name = "Auto Farm Mobs",
	Default = false,
	Callback = function(Value)
...
mainTab:AddParagraph("Auto Farm Boss","when boss haven't spawn will farm selected mob when mob is spawned")
mainTab:AddToggle({
	Name = "Auto Farm Boss",
	Default = false,
	Callback = function(Value)
